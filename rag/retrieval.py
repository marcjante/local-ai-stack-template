...
def retrieve(query: str, top_k: int = 20, doc_id: str = None) -> list:
    """Devuelve los chunks más parecidos a la consulta, sin reordenar todavía."""
    query_embedding = embed_text(query)
    return search(query_embedding, top_k=top_k, doc_id=doc_id)
